...
class EpollPoller : public Poller {
 public:
  ...
  // epoll_ctl to delete the fd of the channel from a epfd. This function would
  // check the channel's state. If the channel is added, it will be delete from
  // this epoll poller and the channel's state will be set to
  // kChannelInitialzed.
